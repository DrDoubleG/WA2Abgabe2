$(document).ready(function () {
    ...
    $.ajax({
        ...
        content += '<a href="product-detail.html" onclick="checkCookie('+obj.id.toString()+')"  title="Produktdetails"><img src="' + obj.bilder.bildpfad + '" class="img-responsive img-fluid pictures" alt="Ahornberger würzig 16x0,50L"></a>';
        content += '</div>';
        content += '<div class="row">';
